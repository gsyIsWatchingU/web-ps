...
async function ensureDatabaseSchema(env) {
  if (!schemaInitializationPromise) {
    schemaInitializationPromise = env.DB.exec(SCHEMA_SQL).catch((error) => {
...
// .wrangler/tmp/bundle-FRY4e9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-FRY4e9/middleware-loader.entry.ts
