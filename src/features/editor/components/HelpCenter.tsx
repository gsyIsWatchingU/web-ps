...
const quickSteps = [
  ...
  "如果想基于图片生成 3D 模型，点击“AI3D”，填写图片 URL（可选）和提示词后点击生成。",
...
const toolGuides = [
  ...
  ["AI3D", "基于图片生成 3D 模型，支持当前图层图片或自定义 URL 图片，生成后提供下载入口。"],
  ["装饰", "添加贴片、徽章、高亮条等辅助元素，补强卖点表达。"]
];

const faqs = [
  ["AI3D 为什么显示不支持？", "AI3D 需要可访问的 http/https URL 图片。如果当前图层是本地上传或 base64 图片，可以在右侧面板输入自定义图片 URL。"],
  ["AI3D 任务失败怎么办？", "原图不会被影响。你可以调整提示词后重试，或检查网络和 API 配置。"],
  ["AI3D 生成的文件在哪里下载？", "任务成功后，会在右侧面板显示下载按钮和文件名，点击即可下载。"],
  ...
  return (
    <div className="help-center">
      ...
      <section className="help-center__section">
        <div className="help-center__copy">
          ...
          <ul className="help-center__list">
            ...
            <li>右侧：比例设置、滤镜、AI3D、导出和当前图层属性。</li>
          </ul>
        </div>
      ...
      <section className="help-center__section">
        ...
        <img alt="AI3D 生成流程" className="help-center__image" src="/help/ai3d.svg" />
      </section>
